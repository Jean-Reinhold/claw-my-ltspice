...
#
# Lote A (itens 1-3) nao tem dependencias e roda em paralelo.
# O item 3 mede o VOS usado como compensacao nos itens 4-6 (vos_comp.inc),
# entao o Lote B (itens 4-6) so comeca depois do Lote A.
set -euo pipefail
...
echo "== Lote A: itens 1-3 em containers paralelos =="
pids=()
