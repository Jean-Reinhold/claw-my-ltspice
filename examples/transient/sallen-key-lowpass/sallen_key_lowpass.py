...
def create_circuit(include_path: str = "../../lib/claw_opamps.lib") -> Circuit:
    ...
    circuit.voltage("VIN", "in", "0", "SINE(0 1 1k)", at=(96, 256))
    circuit.voltage("VCC", "vcc", "0", "5", at=(752, 64))
    circuit.voltage("VEE", "vee", "0", "-5", at=(752, 432))
    circuit.resistor("R1", "in", "n1", "10k", at=(224, 256))
    circuit.resistor("R2", "n1", "filt", "10k", at=(384, 256))
    circuit.capacitor("C1", "n1", "out", "10n", at=(352, 128), rotation="R90")
    circuit.capacitor("C2", "filt", "0", "10n", at=(496, 256))
