...
def create_circuit() -> Circuit:
    ...
    circuit.voltage("V1", "in", "0", "PULSE(0 5 0 1n 1n 5m 10m)", at=(96, 192))
    circuit.resistor("R1", "in", "out", "1k", at=(360, 192))
    circuit.capacitor("C1", "out", "0", "1u", at=(560, 192))
    circuit.wire(64, 192, 360, 192)
    circuit.wire(456, 192, 624, 192)
    circuit.wire(560, 192, 560, 288)
    circuit.iopin(64, 192, "in", "In")
    circuit.iopin(624, 192, "out", "Out")
    circuit.flag(96, 288, "0")
    circuit.flag(560, 288, "0")
