...
pergunta do experimento é simples: dá para treinar uma rede neural de
verdade e construir ela inteira com AmpOps e resistores?
...
A validação foi feita no LTspice em duas rodadas, uma com um modelo
ideal de AmpOp e outra com o macromodelo comercial do LM741, usando
trilhos de alimentação calibrados para compensar a saturação do 741.
