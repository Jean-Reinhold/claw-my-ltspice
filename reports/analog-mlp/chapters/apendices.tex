...
As duas netlists completas (\texttt{analog\_mlp.cir} com o AmpOp ideal
e \texttt{analog\_mlp\_741.cir} com o LM741, cerca de 6600 linhas cada)
são geradas automaticamente a partir dos pesos treinados e ficam em
\texttt{experiments/analog-mlp/}. Abaixo, um trecho representativo,
...
Na variante LM741 mudam só o \texttt{.include}
(\texttt{models/lm741.lib}, modelo do fabricante, baixado à parte por
não ser redistribuível) e os valores dos trilhos, calibrados com
\texttt{bench\_741\_sat.cir} para colocar a saturação dos neurônios em
\SI{0}{\volt} e \SI{4,8}{\volt}. O modelo ideal da primeira variante:
...
circuito e grava os pesos; \texttt{analog\_mlp.py} gera as duas
netlists, os esquemáticos e a figura de topologia;
\texttt{bench\_741\_sat.cir} é a bancada de calibração da saturação do
LM741; \texttt{analyze\_results.py} compara as simulações com o modelo,
