...
derivada foi confirmado por uma segunda medida feita de outra forma (a
inclinação entre dois pontos nos ganhos e a medida entre
$\pm$\SI{10}{\volt} no slew rate).

Um teste extra com um amplificador moderno (ADA4610) no mesmo degrau do
item 6 deu escala aos números: o slew rate medido no modelo foi de
\SI{65.2}{\volt\per\micro\second}, umas 250 vezes o do OP07, com a
mesma montagem e sem compensação de offset.
