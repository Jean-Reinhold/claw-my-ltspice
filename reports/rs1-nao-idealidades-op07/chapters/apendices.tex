...
gerado pelo pipeline com o $V_{OS}$ medido no item 3 e define o
...
* estimativa por secante em +/-10 uV.
.lib LTC.lib
...
# pipeline: lotes paralelos de containers + medidas + graficos
...
O pós-processamento (derivadas por diferenças centrais, extração de
medidas e geração dos gráficos) está no script \texttt{analyze.py} do
experimento. Os resultados numéricos ficam em \texttt{results.json}.
